...
module "UAT_internal" {
  ...
  #remote_port     = "22"
 #ssh_key         = "./id_rsa.pub"
  vm_hostname = ["C-U-in-NMAP2-01","C-U-in-NMBA1-03", "C-U-in-NMAP4-04","C-U-in-NMBAT02","C-U-in-Mo-22","C-U-in-Mo-Tk-23"]
 #vm_hostname = ["VM-C-UAT-internal-NMFS.AP01-11","VM-C-UAT-internal-NMFS.AP02-101"]
  ...
  vm_size         = ["Standard_F4s_v2","Standard_D3_v2","Standard_F4s_v2","Standard_F4s_v2","Standard_F4s_v2","Standard_F2s_v2"]
  storage_account_type    = "Standard_LRS"
  private_ip_address      = ["10.10.65.101","10.10.65.103","10.10.65.104","10.10.65.111","10.10.65.22","10.10.65.23"]
...
module "UAT_internal_Test" {
 ...
 #vm_hostname = ["VM-C-UAT-internal-NMFS.AP01-11","VM-C-UAT-internal-NMFS.AP02-101"]
  ...
  storage_account_type    = "Standard_LRS"
  private_ip_address      = ["10.10.65.11"]
  admin_password = var.admin_password
  admin_username = var.admin_username
  #source_address_prefixes   = ["13.67.111.51"]
...
module "UAT_DMZ_NMFS" {
 ...
 #vm_hostname = "my-vm"
  ...
  storage_account_type    = "Standard_LRS"
  private_ip_address      = ["10.10.64.122"]
  admin_password = var.admin_password
  admin_username = var.admin_username
  #source_address_prefixes   = ["13.67.111.51"]
  tags                  ={
...
module "UAT_DMZ_Mobile" {
 ...
 #vm_hostname = "my-vm"
  ...
  storage_account_type    = "Standard_LRS"
  private_ip_address      = ["10.10.64.22"]
  admin_password = var.admin_password
  admin_username = var.admin_username
  #source_address_prefixes   = ["13.67.111.51"]
  tags                  ={
